...
public class ForestDungeonGateBlock extends AbstractGateBlock {
    ...
    public enum ForestDungeonGatePart implements IGatePart {
        ...
        RIGHT_0("hinge_right_0", DungeonGatePartTypeEnum.HINGE_RIGHT, new Vector3i(1, 0, 0)),
        RIGHT_1("hinge_right_1", DungeonGatePartTypeEnum.HINGE_RIGHT, new Vector3i(1, 1, 0)),
        RIGHT_2("hinge_right_2", DungeonGatePartTypeEnum.HINGE_RIGHT, new Vector3i(1, 2, 0)),
        OPEN_LEFT_0("open_left_0", DungeonGatePartTypeEnum.OPEN_GATEWAY_LEFT, new Vector3i(-1, 0, -1)),
        OPEN_LEFT_1("open_left_1", DungeonGatePartTypeEnum.OPEN_GATEWAY_LEFT, new Vector3i(-1, 1, -1)),
        OPEN_LEFT_2("open_left_2", DungeonGatePartTypeEnum.OPEN_GATEWAY_LEFT, new Vector3i(-1, 2, -1)),
        OPEN_RIGHT_0("open_right_0", DungeonGatePartTypeEnum.OPEN_GATEWAY_RIGHT, new Vector3i(1, 0, -1)),
        OPEN_RIGHT_1("open_right_1", DungeonGatePartTypeEnum.OPEN_GATEWAY_RIGHT, new Vector3i(1, 1, -1)),
        OPEN_RIGHT_2("open_right_2", DungeonGatePartTypeEnum.OPEN_GATEWAY_RIGHT, new Vector3i(1, 2, -1));
