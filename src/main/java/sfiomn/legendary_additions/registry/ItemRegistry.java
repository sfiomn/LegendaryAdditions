...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> TINY_XP_BOTTLE_ITEM = ITEMS.register("tiny_xp_bottle", () -> new XpBottleItem(XpBottleEnum.TINY, new Item.Properties()));
    public static final RegistryObject<Item> COMMON_XP_BOTTLE_ITEM = ITEMS.register("common_xp_bottle", () -> new XpBottleItem(XpBottleEnum.COMMON, new Item.Properties()));
    public static final RegistryObject<Item> RARE_XP_BOTTLE_ITEM = ITEMS.register("rare_xp_bottle", () -> new XpBottleItem(XpBottleEnum.RARE, new Item.Properties()));
    public static final RegistryObject<Item> EPIC_XP_BOTTLE_ITEM = ITEMS.register("epic_xp_bottle", () -> new XpBottleItem(XpBottleEnum.EPIC, new Item.Properties()));
    public static final RegistryObject<Item> LEGENDARY_XP_BOTTLE_ITEM = ITEMS.register("legendary_xp_bottle", () -> new XpBottleItem(XpBottleEnum.LEGENDARY, new Item.Properties()));
