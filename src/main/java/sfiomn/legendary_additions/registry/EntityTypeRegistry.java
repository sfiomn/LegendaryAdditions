...
import sfiomn.legendary_additions.entities.LegendaryXpBottleEntity;

public class EntityTypeRegistry {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, LegendaryAdditions.MOD_ID);
    ...
    public static final RegistryObject<EntityType<TinyXpBottleEntity>> TINY_XP_BOTTLE_ENTITY = ENTITY_TYPES.register( "tiny_xp_bottle",
            () -> EntityType.Builder.of((EntityType.EntityFactory<TinyXpBottleEntity>) TinyXpBottleEntity::new, MobCategory.MISC)
                    .sized(0.5F, 0.5F)
    ...
    public static final RegistryObject<EntityType<CommonXpBottleEntity>> COMMON_XP_BOTTLE_ENTITY = ENTITY_TYPES.register("common_xp_bottle",
            () -> EntityType.Builder.of((EntityType.EntityFactory<CommonXpBottleEntity>) CommonXpBottleEntity::new, MobCategory.MISC)
                    .sized(0.5F, 0.5F)
                    .clientTrackingRange(64)
                    .setShouldReceiveVelocityUpdates(true)
                    .setUpdateInterval(3)
    ...
    public static final RegistryObject<EntityType<RareXpBottleEntity>> RARE_XP_BOTTLE_ENTITY = ENTITY_TYPES.register("rare_xp_bottle",
            () -> EntityType.Builder.of((EntityType.EntityFactory<RareXpBottleEntity>) RareXpBottleEntity::new, MobCategory.MISC)
                    .sized(0.5F, 0.5F)
                    .clientTrackingRange(64)
                    .setShouldReceiveVelocityUpdates(true)
                    .setUpdateInterval(3)
    ...
    public static final RegistryObject<EntityType<EpicXpBottleEntity>> EPIC_XP_BOTTLE_ENTITY = ENTITY_TYPES.register("epic_xp_bottle",
            () -> EntityType.Builder.of((EntityType.EntityFactory<EpicXpBottleEntity>) EpicXpBottleEntity::new, MobCategory.MISC)
                    .sized(0.5F, 0.5F)
                    .clientTrackingRange(64)
                    .setShouldReceiveVelocityUpdates(true)
                    .setUpdateInterval(3)
    ...
    public static final RegistryObject<EntityType<LegendaryXpBottleEntity>> LEGENDARY_XP_BOTTLE_ENTITY = ENTITY_TYPES.register("legendary_xp_bottle",
            () -> EntityType.Builder.of((EntityType.EntityFactory<LegendaryXpBottleEntity>) LegendaryXpBottleEntity::new, MobCategory.MISC)
                    .sized(0.5F, 0.5F)
                    .clientTrackingRange(64)
                    .setShouldReceiveVelocityUpdates(true)
                    .setUpdateInterval(3)
